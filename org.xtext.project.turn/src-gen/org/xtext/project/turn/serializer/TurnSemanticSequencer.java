...
public class TurnSemanticSequencer extends XbaseSemanticSequencer {
	...
	public void sequence(ISerializationContext context, EObject semanticObject) {
		...
		if (epackage == TurnPackage.eINSTANCE)
			...
			case TurnPackage.ARTIFICIAL_RULE:
				...
				return; 
			case TurnPackage.BOOLEAN_INITIALIZATION:
			...
			case TurnPackage.ENDPOINT_WITH_CONNECT:
				...
				return; 
			case TurnPackage.ENUM_INITIALIZATION:
				sequence_EnumInitialization(context, (EnumInitialization) semanticObject); 
				return; 
			case TurnPackage.ENUMERATION_LITERAL:
				sequence_EnumerationLiteral(context, (EnumerationLiteral) semanticObject); 
				return; 
			case TurnPackage.ENUMERATION_TYPE:
				sequence_EnumerationType(context, (EnumerationType) semanticObject); 
				return; 
			case TurnPackage.ENUMERATION_TYPE_KIND:
				sequence_EnumerationTypeKind(context, (EnumerationTypeKind) semanticObject); 
				return; 
			...
			case TurnPackage.INDICATOR_EVALUATION:
				...
				return; 
			case TurnPackage.INTEGER_INITIALIZATION:
	...
	/**
	 * Contexts:
	 *     URNmodelElement returns BooleanInitialization
	 *     Initialization returns BooleanInitialization
	...
	protected void sequence_BooleanInitialization(ISerializationContext context, BooleanInitialization semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.INITIALIZATION__VARIABLE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.INITIALIZATION__VARIABLE));
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.BOOLEAN_INITIALIZATION__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.BOOLEAN_INITIALIZATION__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getBooleanInitializationAccess().getVariableVariableQualifiedNameParserRuleCall_0_0_1(), semanticObject.eGet(TurnPackage.Literals.INITIALIZATION__VARIABLE, false));
		feeder.accept(grammarAccess.getBooleanInitializationAccess().getValueBooleanParserRuleCall_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     URNmodelElement returns EnumInitialization
	 *     Initialization returns EnumInitialization
	 *     EnumInitialization returns EnumInitialization
	 *
	 * Constraint:
	 *     (variable=[Variable|QualifiedName] value=EnumerationLiteral)
	 */
	protected void sequence_EnumInitialization(ISerializationContext context, EnumInitialization semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.INITIALIZATION__VARIABLE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.INITIALIZATION__VARIABLE));
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.ENUM_INITIALIZATION__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.ENUM_INITIALIZATION__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getEnumInitializationAccess().getVariableVariableQualifiedNameParserRuleCall_0_0_1(), semanticObject.eGet(TurnPackage.Literals.INITIALIZATION__VARIABLE, false));
		feeder.accept(grammarAccess.getEnumInitializationAccess().getValueEnumerationLiteralParserRuleCall_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	...
	protected void sequence_EnumerationLiteral(ISerializationContext context, EnumerationLiteral semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.ENUMERATION_LITERAL__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.ENUMERATION_LITERAL__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getEnumerationLiteralAccess().getNameQualifiedNameParserRuleCall_0(), semanticObject.getName());
		feeder.finish();
	}
	...
	/**
	 * Contexts:
	 *     DatatypeKind returns EnumerationTypeKind
	 *     EnumerationTypeKind returns EnumerationTypeKind
	 *
	 * Constraint:
	 *     enumerationType=[EnumerationType|QualifiedName]
	 */
	protected void sequence_EnumerationTypeKind(ISerializationContext context, EnumerationTypeKind semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.ENUMERATION_TYPE_KIND__ENUMERATION_TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.ENUMERATION_TYPE_KIND__ENUMERATION_TYPE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getEnumerationTypeKindAccess().getEnumerationTypeEnumerationTypeQualifiedNameParserRuleCall_0_1(), semanticObject.eGet(TurnPackage.Literals.ENUMERATION_TYPE_KIND__ENUMERATION_TYPE, false));
		feeder.finish();
	}
	 ...
	 *
	 * Constraint:
	 *     (name=QualifiedName enumLiteral+=EnumerationLiteral enumLiterals+=QualifiedName*)
	 */
	...
	/**
	 * Contexts:
	 *     URNmodelElement returns IntegerInitialization
	 *     Initialization returns IntegerInitialization
	...
	protected void sequence_IntegerInitialization(ISerializationContext context, IntegerInitialization semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.INITIALIZATION__VARIABLE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.INITIALIZATION__VARIABLE));
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.INTEGER_INITIALIZATION__VALUE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.INTEGER_INITIALIZATION__VALUE));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getIntegerInitializationAccess().getVariableVariableQualifiedNameParserRuleCall_0_0_1(), semanticObject.eGet(TurnPackage.Literals.INITIALIZATION__VARIABLE, false));
		feeder.accept(grammarAccess.getIntegerInitializationAccess().getValueINTTerminalRuleCall_2_0(), semanticObject.getValue());
		feeder.finish();
	}
	 ...
	 *         (startPoint+=[StartPoint|QualifiedName] startPoints+=[StartPoint|QualifiedName]*)* 
	 *         (endPoints+=[EndPoint|QualifiedName] endPoints+=[EndPoint|QualifiedName]*)* 
	 ...
	 *
	 * Constraint:
	 *     (name=QualifiedName longName=LongName scenario=[ScenarioDef|QualifiedName] scenarios+=[ScenarioDef|QualifiedName]*)
	 */
	 ...
	 *
	 * Constraint:
	 *     (((name=QualifiedName longName=LongName)? precondition=Condition?) | (failKind=FailureKind name=QualifiedName longName=LongName catches=STRING?))
	 */
	...
	protected void sequence_Variable(ISerializationContext context, Variable semanticObject) {
		if (errorAcceptor != null) {
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.VARIABLE__TYPE) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.VARIABLE__TYPE));
			if (transientValues.isValueTransient(semanticObject, TurnPackage.Literals.VARIABLE__NAME) == ValueTransient.YES)
				errorAcceptor.accept(diagnosticProvider.createFeatureValueMissing(semanticObject, TurnPackage.Literals.VARIABLE__NAME));
		}
		SequenceFeeder feeder = createSequencerFeeder(context, semanticObject);
		feeder.accept(grammarAccess.getVariableAccess().getTypeDatatypeKindParserRuleCall_0_0(), semanticObject.getType());
