...
public class TurnSyntacticSequencer extends AbstractSyntacticSequencer {
	...
	protected AbstractElementAlias match_AndFork_EndPoint___AndKeyword_0_LeftCurlyBracketKeyword_2_RightCurlyBracketKeyword_4___or___EndKeyword_0_FullStopKeyword_3__;
	protected AbstractElementAlias match_AndFork___AndKeyword_0_LeftCurlyBracketKeyword_2_RightCurlyBracketKeyword_4__q;
	...
	protected String getUnassignedRuleCallToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		...
		else if (ruleCall.getRule() == grammarAccess.getPrimaryTypeKindRule())
			return getPrimaryTypeKindToken(semanticObject, ruleCall, node);
		return "";
	}
	 ...
	 * 	'bool' | 'int';
	 */
	protected String getPrimaryTypeKindToken(EObject semanticObject, RuleCall ruleCall, INode node) {
		if (node != null)
			return getTokenText(node);
		return "bool";
	}
	...
	protected void emitUnassignedTokens(EObject semanticObject, ISynTransition transition, INode fromNode, INode toNode) {
		...
		for (AbstractElementAlias syntax : transition.getAmbiguousSyntaxes()) {
			...
			if (match_AndFork_EndPoint___AndKeyword_0_LeftCurlyBracketKeyword_2_RightCurlyBracketKeyword_4___or___EndKeyword_0_FullStopKeyword_3__.equals(syntax))
				emit_AndFork_EndPoint___AndKeyword_0_LeftCurlyBracketKeyword_2_RightCurlyBracketKeyword_4___or___EndKeyword_0_FullStopKeyword_3__(semanticObject, getLastNavigableState(), syntaxNodes);
			else if (match_AndFork___AndKeyword_0_LeftCurlyBracketKeyword_2_RightCurlyBracketKeyword_4__q.equals(syntax))
				emit_AndFork___AndKeyword_0_LeftCurlyBracketKeyword_2_RightCurlyBracketKeyword_4__q(semanticObject, getLastNavigableState(), syntaxNodes);
	 ...
	 */
	protected void emit_AndFork_EndPoint___AndKeyword_0_LeftCurlyBracketKeyword_2_RightCurlyBracketKeyword_4___or___EndKeyword_0_FullStopKeyword_3__(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
	 ...
	 *     (rule start) (ambiguity) (rule start)
	 */
	protected void emit_AndFork___AndKeyword_0_LeftCurlyBracketKeyword_2_RightCurlyBracketKeyword_4__q(EObject semanticObject, ISynNavigable transition, List<INode> nodes) {
		acceptNodes(transition, nodes);
	}
