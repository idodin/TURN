...
import org.xtext.project.turn.turn.EnumInitialization;
...
import org.xtext.project.turn.turn.IntegerInitialization;
...
public class TurnPackageImpl extends EPackageImpl implements TurnPackage
{
   ...
   * @generated
   */
  private EClass enumInitializationEClass = null;
   ...
   * @generated
   */
  private EClass datatypeKindEClass = null;
   ...
   * @generated
   */
  private EClass enumerationTypeKindEClass = null;
   ...
   * @generated
   */
  public EReference getURNspec_ScenarioGroups()
  {
   ...
   * @generated
   */
  public EReference getURNspec_ScenarioDefs()
  {
   ...
   * @generated
   */
  public EReference getURNspec_EnumType()
  {
   ...
   * @generated
   */
  public EReference getScenarioDef_Initialize()
  {
   ...
   * @generated
   */
  public EReference getScenarioDef_StartPoint()
  {
   ...
   * @generated
   */
  public EClass getEnumInitialization()
  {
    return enumInitializationEClass;
  }
   ...
   * @generated
   */
  public EReference getEnumInitialization_Value()
  {
    return (EReference)enumInitializationEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EClass getDatatypeKind()
  {
    return datatypeKindEClass;
  }
   ...
   * @generated
   */
  public EClass getEnumerationTypeKind()
  {
    return enumerationTypeKindEClass;
  }
   ...
   * @generated
   */
  public EReference getEnumerationTypeKind_EnumerationType()
  {
    return (EReference)enumerationTypeKindEClass.getEStructuralFeatures().get(0);
  }
   ...
   * @generated
   */
  public EReference getEnumerationType_EnumLiteral()
  {
  ...
  public void createPackageContents()
  {
    ...
    createEReference(urNspecEClass, UR_NSPEC__SCENARIO_GROUPS);
    createEReference(urNspecEClass, UR_NSPEC__SCENARIO_DEFS);
    createEReference(urNspecEClass, UR_NSPEC__VARIABLES);
    createEReference(urNspecEClass, UR_NSPEC__ENUM_TYPE);
    ...
    createEReference(scenarioDefEClass, SCENARIO_DEF__INITIALIZE);
    createEReference(scenarioDefEClass, SCENARIO_DEF__START_POINT);
    ...
    enumInitializationEClass = createEClass(ENUM_INITIALIZATION);
    createEReference(enumInitializationEClass, ENUM_INITIALIZATION__VALUE);

    variableEClass = createEClass(VARIABLE);
    createEReference(variableEClass, VARIABLE__TYPE);
    createEAttribute(variableEClass, VARIABLE__NAME);

    datatypeKindEClass = createEClass(DATATYPE_KIND);

    enumerationTypeKindEClass = createEClass(ENUMERATION_TYPE_KIND);
    createEReference(enumerationTypeKindEClass, ENUMERATION_TYPE_KIND__ENUMERATION_TYPE);

    enumerationTypeEClass = createEClass(ENUMERATION_TYPE);
    createEAttribute(enumerationTypeEClass, ENUMERATION_TYPE__NAME);
    createEReference(enumerationTypeEClass, ENUMERATION_TYPE__ENUM_LITERAL);
    createEAttribute(enumerationTypeEClass, ENUMERATION_TYPE__ENUM_LITERALS);
  ...
  public void initializePackageContents()
  {
    ...
    initializationEClass.getESuperTypes().add(this.getURNmodelElement());
    booleanInitializationEClass.getESuperTypes().add(this.getInitialization());
    integerInitializationEClass.getESuperTypes().add(this.getInitialization());
    enumInitializationEClass.getESuperTypes().add(this.getInitialization());
    enumerationTypeKindEClass.getESuperTypes().add(this.getDatatypeKind());
    ...
    initEReference(getURNspec_ScenarioGroups(), this.getScenarioGroup(), null, "scenarioGroups", null, 0, -1, URNspec.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getURNspec_ScenarioDefs(), this.getScenarioDef(), null, "scenarioDefs", null, 0, -1, URNspec.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getURNspec_EnumType(), this.getEnumerationType(), null, "enumType", null, 0, -1, URNspec.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getScenarioGroup_Scenario(), this.getScenarioDef(), null, "scenario", null, 0, 1, ScenarioGroup.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getScenarioDef_Initialize(), this.getInitialization(), null, "initialize", null, 0, -1, ScenarioDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEReference(getScenarioDef_StartPoint(), this.getStartPoint(), null, "startPoint", null, 0, -1, ScenarioDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getScenarioDef_IncludedScenario(), this.getScenarioDef(), null, "includedScenario", null, 0, -1, ScenarioDef.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEClass(enumInitializationEClass, EnumInitialization.class, "EnumInitialization", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getEnumInitialization_Value(), this.getEnumerationLiteral(), null, "value", null, 0, 1, EnumInitialization.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(variableEClass, Variable.class, "Variable", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getVariable_Type(), this.getDatatypeKind(), null, "type", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getVariable_Name(), ecorePackage.getEString(), "name", null, 0, 1, Variable.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);

    initEClass(datatypeKindEClass, DatatypeKind.class, "DatatypeKind", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);

    initEClass(enumerationTypeKindEClass, EnumerationTypeKind.class, "EnumerationTypeKind", !IS_ABSTRACT, !IS_INTERFACE, IS_GENERATED_INSTANCE_CLASS);
    initEReference(getEnumerationTypeKind_EnumerationType(), this.getEnumerationType(), null, "enumerationType", null, 0, 1, EnumerationTypeKind.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_COMPOSITE, IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    ...
    initEReference(getEnumerationType_EnumLiteral(), this.getEnumerationLiteral(), null, "enumLiteral", null, 0, -1, EnumerationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, IS_COMPOSITE, !IS_RESOLVE_PROXIES, !IS_UNSETTABLE, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
    initEAttribute(getEnumerationType_EnumLiterals(), ecorePackage.getEString(), "enumLiterals", null, 0, -1, EnumerationType.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, !IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
