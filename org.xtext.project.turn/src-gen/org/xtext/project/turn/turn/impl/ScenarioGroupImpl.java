...
public class ScenarioGroupImpl extends URNmodelElementImpl implements ScenarioGroup
{
  ...
  public ScenarioDef getScenario()
  {
    if (scenario != null && scenario.eIsProxy())
    {
      ...
      {
        if (eNotificationRequired())
          eNotify(new ENotificationImpl(this, Notification.RESOLVE, TurnPackage.SCENARIO_GROUP__SCENARIO, oldScenario, scenario));
      }
    }
    return scenario;
  }
  ...
  public void setScenario(ScenarioDef newScenario)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TurnPackage.SCENARIO_GROUP__SCENARIO, oldScenario, scenario));
  }
