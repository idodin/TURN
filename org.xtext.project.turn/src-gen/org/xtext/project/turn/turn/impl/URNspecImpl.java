 ...
 *   <li>{@link org.xtext.project.turn.turn.impl.URNspecImpl#getScenarioGroups <em>Scenario Groups</em>}</li>
 *   <li>{@link org.xtext.project.turn.turn.impl.URNspecImpl#getScenarioDefs <em>Scenario Defs</em>}</li>
 *   <li>{@link org.xtext.project.turn.turn.impl.URNspecImpl#getVariables <em>Variables</em>}</li>
 *   <li>{@link org.xtext.project.turn.turn.impl.URNspecImpl#getEnumType <em>Enum Type</em>}</li>
...
public class URNspecImpl extends MinimalEObjectImpl.Container implements URNspec
{
   ...
   * @ordered
   */
  protected EList<EnumerationType> enumType;
  ...
  public EList<ScenarioGroup> getScenarioGroups()
  {
    ...
    {
      scenarioGroups = new EObjectContainmentEList<ScenarioGroup>(ScenarioGroup.class, this, TurnPackage.UR_NSPEC__SCENARIO_GROUPS);
    }
  ...
  public EList<ScenarioDef> getScenarioDefs()
  {
    ...
    {
      scenarioDefs = new EObjectContainmentEList<ScenarioDef>(ScenarioDef.class, this, TurnPackage.UR_NSPEC__SCENARIO_DEFS);
    }
    return scenarioDefs;
  }
   ...
   * @generated
   */
  public EList<EnumerationType> getEnumType()
  {
    if (enumType == null)
    {
      enumType = new EObjectContainmentEList<EnumerationType>(EnumerationType.class, this, TurnPackage.UR_NSPEC__ENUM_TYPE);
    }
    return enumType;
  }
  ...
  public void eSet(int featureID, Object newValue)
  {
    switch (featureID)
    {
      ...
      case TurnPackage.UR_NSPEC__ENUM_TYPE:
        getEnumType().clear();
        getEnumType().addAll((Collection<? extends EnumerationType>)newValue);
        return;
      case TurnPackage.UR_NSPEC__METADATA:
        getMetadata().clear();
