...
public class TurnSwitch<T> extends Switch<T>
{
  ...
  protected T doSwitch(int classifierID, EObject theEObject)
  {
    switch (classifierID)
    {
      ...
      case TurnPackage.INITIALIZATION:
      {
        ...
        if (result == null) result = caseURNmodelElement(initialization);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case TurnPackage.BOOLEAN_INITIALIZATION:
      {
        ...
        if (result == null) result = caseInitialization(booleanInitialization);
        if (result == null) result = caseURNmodelElement(booleanInitialization);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case TurnPackage.INTEGER_INITIALIZATION:
      {
        ...
        if (result == null) result = caseInitialization(integerInitialization);
        if (result == null) result = caseURNmodelElement(integerInitialization);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case TurnPackage.ENUM_INITIALIZATION:
      {
        EnumInitialization enumInitialization = (EnumInitialization)theEObject;
        T result = caseEnumInitialization(enumInitialization);
        if (result == null) result = caseInitialization(enumInitialization);
        if (result == null) result = caseURNmodelElement(enumInitialization);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      ...
      case TurnPackage.DATATYPE_KIND:
      {
        DatatypeKind datatypeKind = (DatatypeKind)theEObject;
        T result = caseDatatypeKind(datatypeKind);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
      case TurnPackage.ENUMERATION_TYPE_KIND:
      {
        EnumerationTypeKind enumerationTypeKind = (EnumerationTypeKind)theEObject;
        T result = caseEnumerationTypeKind(enumerationTypeKind);
        if (result == null) result = caseDatatypeKind(enumerationTypeKind);
        if (result == null) result = defaultCase(theEObject);
        return result;
      }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Enum Initialization</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Enum Initialization</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEnumInitialization(EnumInitialization object)
  {
    return null;
  }
  ...
  /**
   * Returns the result of interpreting the object as an instance of '<em>Datatype Kind</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Datatype Kind</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseDatatypeKind(DatatypeKind object)
  {
    return null;
  }

  /**
   * Returns the result of interpreting the object as an instance of '<em>Enumeration Type Kind</em>'.
   * <!-- begin-user-doc -->
   * This implementation returns null;
   * returning a non-null result will terminate the switch.
   * <!-- end-user-doc -->
   * @param object the target of the switch.
   * @return the result of interpreting the object as an instance of '<em>Enumeration Type Kind</em>'.
   * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
   * @generated
   */
  public T caseEnumerationTypeKind(EnumerationTypeKind object)
  {
    return null;
  }
