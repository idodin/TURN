 ...
 *   <li>{@link org.xtext.project.turn.turn.URNspec#getScenarioGroups <em>Scenario Groups</em>}</li>
 *   <li>{@link org.xtext.project.turn.turn.URNspec#getScenarioDefs <em>Scenario Defs</em>}</li>
 *   <li>{@link org.xtext.project.turn.turn.URNspec#getVariables <em>Variables</em>}</li>
 *   <li>{@link org.xtext.project.turn.turn.URNspec#getEnumType <em>Enum Type</em>}</li>
...
public interface URNspec extends EObject
{
   ...
   * @see org.xtext.project.turn.turn.TurnPackage#getURNspec_ScenarioGroups()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.xtext.project.turn.turn.TurnPackage#getURNspec_ScenarioDefs()
   * @model containment="true"
   * @generated
   */
   ...
   * @see org.xtext.project.turn.turn.TurnPackage#getURNspec_EnumType()
   * @model containment="true"
   * @generated
   */
  EList<EnumerationType> getEnumType();
