...
public class TurnParser extends AbstractContentAssistParser {
	...
	public static final class NameMappings {
		...
		private static void init(ImmutableMap.Builder<AbstractElement, String> builder, TurnGrammarAccess grammarAccess) {
			...
			builder.put(grammarAccess.getDatatypeKindAccess().getAlternatives(), "rule__DatatypeKind__Alternatives");
			builder.put(grammarAccess.getPrimaryTypeKindAccess().getAlternatives(), "rule__PrimaryTypeKind__Alternatives");
			...
			builder.put(grammarAccess.getStartPointAccess().getGroup_0_1_1(), "rule__StartPoint__Group_0_1_1__0");
			...
			builder.put(grammarAccess.getScenarioGroupAccess().getGroup_3(), "rule__ScenarioGroup__Group_3__0");
			builder.put(grammarAccess.getScenarioGroupAccess().getGroup_3_2(), "rule__ScenarioGroup__Group_3_2__0");
			builder.put(grammarAccess.getScenarioDefAccess().getGroup(), "rule__ScenarioDef__Group__0");
			builder.put(grammarAccess.getScenarioDefAccess().getGroup_3(), "rule__ScenarioDef__Group_3__0");
			...
			builder.put(grammarAccess.getScenarioDefAccess().getGroup_6_2(), "rule__ScenarioDef__Group_6_2__0");
			...
			builder.put(grammarAccess.getBooleanInitializationAccess().getGroup(), "rule__BooleanInitialization__Group__0");
			builder.put(grammarAccess.getIntegerInitializationAccess().getGroup(), "rule__IntegerInitialization__Group__0");
			builder.put(grammarAccess.getEnumInitializationAccess().getGroup(), "rule__EnumInitialization__Group__0");
			...
			builder.put(grammarAccess.getURNspecAccess().getScenarioGroupsAssignment_11(), "rule__URNspec__ScenarioGroupsAssignment_11");
			builder.put(grammarAccess.getURNspecAccess().getScenarioDefsAssignment_12(), "rule__URNspec__ScenarioDefsAssignment_12");
			builder.put(grammarAccess.getURNspecAccess().getVariablesAssignment_13(), "rule__URNspec__VariablesAssignment_13");
			builder.put(grammarAccess.getURNspecAccess().getEnumTypeAssignment_14(), "rule__URNspec__EnumTypeAssignment_14");
			...
			builder.put(grammarAccess.getStartPointAccess().getNameAssignment_0_1_1_0(), "rule__StartPoint__NameAssignment_0_1_1_0");
			builder.put(grammarAccess.getStartPointAccess().getLongNameAssignment_0_1_1_1(), "rule__StartPoint__LongNameAssignment_0_1_1_1");
			builder.put(grammarAccess.getStartPointAccess().getPreconditionAssignment_0_1_2(), "rule__StartPoint__PreconditionAssignment_0_1_2");
			...
			builder.put(grammarAccess.getScenarioGroupAccess().getScenarioAssignment_3_1(), "rule__ScenarioGroup__ScenarioAssignment_3_1");
			builder.put(grammarAccess.getScenarioGroupAccess().getScenariosAssignment_3_2_1(), "rule__ScenarioGroup__ScenariosAssignment_3_2_1");
			builder.put(grammarAccess.getScenarioDefAccess().getNameAssignment_1(), "rule__ScenarioDef__NameAssignment_1");
			builder.put(grammarAccess.getScenarioDefAccess().getPreconditionsAssignment_3_1(), "rule__ScenarioDef__PreconditionsAssignment_3_1");
			builder.put(grammarAccess.getScenarioDefAccess().getPostconditionsAssignment_4_1(), "rule__ScenarioDef__PostconditionsAssignment_4_1");
			builder.put(grammarAccess.getScenarioDefAccess().getInitializeAssignment_5_1(), "rule__ScenarioDef__InitializeAssignment_5_1");
			builder.put(grammarAccess.getScenarioDefAccess().getStartPointAssignment_6_1(), "rule__ScenarioDef__StartPointAssignment_6_1");
			builder.put(grammarAccess.getScenarioDefAccess().getStartPointsAssignment_6_2_1(), "rule__ScenarioDef__StartPointsAssignment_6_2_1");
			builder.put(grammarAccess.getScenarioDefAccess().getEndPointsAssignment_7_1(), "rule__ScenarioDef__EndPointsAssignment_7_1");
			builder.put(grammarAccess.getScenarioDefAccess().getEndPointsAssignment_7_2_1(), "rule__ScenarioDef__EndPointsAssignment_7_2_1");
			builder.put(grammarAccess.getScenarioDefAccess().getIncludedScenarioAssignment_8_1(), "rule__ScenarioDef__IncludedScenarioAssignment_8_1");
			builder.put(grammarAccess.getScenarioDefAccess().getIncludedScenariosAssignment_8_2_1(), "rule__ScenarioDef__IncludedScenariosAssignment_8_2_1");
			builder.put(grammarAccess.getBooleanInitializationAccess().getVariableAssignment_0(), "rule__BooleanInitialization__VariableAssignment_0");
			builder.put(grammarAccess.getBooleanInitializationAccess().getValueAssignment_2(), "rule__BooleanInitialization__ValueAssignment_2");
			builder.put(grammarAccess.getIntegerInitializationAccess().getVariableAssignment_0(), "rule__IntegerInitialization__VariableAssignment_0");
			builder.put(grammarAccess.getIntegerInitializationAccess().getValueAssignment_2(), "rule__IntegerInitialization__ValueAssignment_2");
			builder.put(grammarAccess.getEnumInitializationAccess().getVariableAssignment_0(), "rule__EnumInitialization__VariableAssignment_0");
			builder.put(grammarAccess.getEnumInitializationAccess().getValueAssignment_2(), "rule__EnumInitialization__ValueAssignment_2");
			...
			builder.put(grammarAccess.getEnumerationTypeKindAccess().getEnumerationTypeAssignment(), "rule__EnumerationTypeKind__EnumerationTypeAssignment");
			builder.put(grammarAccess.getEnumerationTypeAccess().getNameAssignment_1(), "rule__EnumerationType__NameAssignment_1");
			builder.put(grammarAccess.getEnumerationTypeAccess().getEnumLiteralAssignment_3(), "rule__EnumerationType__EnumLiteralAssignment_3");
			builder.put(grammarAccess.getEnumerationTypeAccess().getEnumLiteralsAssignment_4_1(), "rule__EnumerationType__EnumLiteralsAssignment_4_1");
